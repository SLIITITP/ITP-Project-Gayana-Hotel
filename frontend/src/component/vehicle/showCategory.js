...
export default function ShowVehicle() {
    ...
    const onDelete = (id) => {
        axios.delete(`http://localhost:8080/api/vehicle/delete/${id}`)
            .then(() => {
                setVehicle(prevCategories=> prevCategories.filter(vehicle => vehicle._id !== id));
    ...
    return (
        ...
        <div className='m-2'>
          ...
          <a href='/vehicle/add' style={{textDecoration:'none',color:'white'}}>Create New Vehicle</a></button>
