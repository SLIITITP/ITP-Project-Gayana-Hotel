...
export default function ShowRoom() {
    ...
    //     doc.text("All Rooms", 10, 10);
    //     // iterate over Rooms and add them to the document
    //     Rooms.forEach((Room, index) => {
    //       const yPos = 20 + index * 10;
    //       doc.text(`${index + 1}. ${Room.RoomType} - ${Room.price} - ${Room.description}`, 10, yPos);
